...
namespace BankRepository
{
    ...
    partial void DeleteCustomer(Customer instance);
		...
		public BankDataContextDataContext() : 
				base(global::BankRepository.Properties.Settings.Default.bankdbConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Customer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _SocialSequrityNumber;
    ...
    partial void OnSocialSequrityNumberChanging(string value);
    partial void OnSocialSequrityNumberChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SocialSequrityNumber", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string SocialSequrityNumber
		{
			get
			{
				return this._SocialSequrityNumber;
			}
			set
			{
				if ((this._SocialSequrityNumber != value))
				{
					this.OnSocialSequrityNumberChanging(value);
					this.SendPropertyChanging();
					this._SocialSequrityNumber = value;
					this.SendPropertyChanged("SocialSequrityNumber");
					this.OnSocialSequrityNumberChanged();
				}
			}
		}
